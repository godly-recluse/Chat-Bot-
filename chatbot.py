...
st.markdown("<h1 style = 'color: #0C356A; text-align: center; font-family: Times New Roman, Times, serif;'>Titos Chatbot</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #DA0C81; text-align: center; font-family: cursive '>Built By Tito</h4>", unsafe_allow_html = True)

st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('pngwing.com (9).png', caption = 'Mental Health Related Chats')
...
st.write(f'\t\t\t\t\tWelcome To Titos ChatBot\n\n')
#while True:
